...
public class Player : MonoBehaviour
{
    ...
    public Slider cooldownBar; // ��Ÿ�� �����
    public Text cooldownText; // ��Ÿ�� ǥ�� �ؽ�Ʈ
    public Text resultText; // ����/���� ��� �ؽ�Ʈ

    [Header("���/ȸ�� ����")]
    public float defenseWindow = 0.5f; // ���/ȸ�� �Է� ��ȿ �ð� (��)
    public float defenseActionCooldown = 3f; // ���/ȸ�� ��Ÿ�� (��)
    ...
    void CreateUITexts()
    {
        ...
        if (cooldownBar == null)
        {
            ...
            fillImage.color = new Color(0.3f, 1f, 0.3f, 1f); // �ʷϻ�
    ...
    void UpdateCooldownUI()
    {
        ...
        if (isOnCooldown)
        {
            cooldownText.text = $"��Ÿ��: {cooldownTimer:F1}��";
